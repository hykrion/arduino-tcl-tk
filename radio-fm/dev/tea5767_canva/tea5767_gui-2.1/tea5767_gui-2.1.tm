...
package provide tea5767_gui 2.1
...
namespace eval tea5767_gui {
  ...
  proc init_images {} {
    # Canvas
    image create photo cnvRadio -file [file nativename tea5767_gui-2.1/img/caratula-1.png]
    image create photo cnvConfiguration -file [file nativename tea5767_gui-2.1/img/configuration.png]
    image create photo cnvStations -file [file nativename tea5767_gui-2.1/img/stations.png]
    
    # widgets
    image create photo imgShutdown -file [file nativename tea5767_gui-2.1/img/boton-apagado.png]
    image create photo imgBurger -file [file nativename tea5767_gui-2.1/img/boton-lista.png]
    image create photo imgMuteOff -file [file nativename tea5767_gui-2.1/img/mute-off.png]
    image create photo imgMuteOn -file [file nativename tea5767_gui-2.1/img/mute-on.png]
    image create photo imgStereoOn -file [file nativename tea5767_gui-2.1/img/stereo-on.png]
    image create photo imgStereoOff -file [file nativename tea5767_gui-2.1/img/stereo-off.png]
    image create photo imgBack -file [file nativename tea5767_gui-2.1/img/back.png]
    image create photo imgVolLow -file [file nativename tea5767_gui-2.1/img/vol-low.png]
    image create photo imgVolHigh -file [file nativename tea5767_gui-2.1/img/vol-high.png]
    image create photo imgLeftArrow -file [file nativename tea5767_gui-2.1/img/left-arrow.png]
    image create photo imgRightArrow -file [file nativename tea5767_gui-2.1/img/right-arrow.png]
    image create photo imgAddStation -file [file nativename tea5767_gui-2.1/img/add.png]
    image create photo imgRemoveStation -file [file nativename tea5767_gui-2.1/img/remove.png]
    image create photo imgPoint -file [file nativename tea5767_gui-2.1/img/point.png]
  }
  # ---------------------------------------------
  proc int_main_canvas {} {
    ...
    set rightArrow [$cnv create image 335 510 -image imgRightArrow -anchor nw]
    set leftArrow [$cnv create image 20 510 -image imgLeftArrow -anchor nw]
    ...
    # dial digital
    $cnv create text 200 310 -fill white -text $radio(dial) -font fntDial -tags digitalDial
    $cnv create text 200 150 -fill white -text $radio(stationName) -tags stationName
