...
namespace eval tea5767_gui {
  ...
  proc config {} {
    ...
    # canvas
    set cnv [canvas .configuration.canvas -width 380 -height 626]   
    ...
    # bind
    $cnv bind $back <ButtonPress-1> [namespace code {close_dialog .configuration}]
  ...
  proc stations {} {
    ...
    # canvas
    set cnv [canvas .stations.canvas -width 380 -height 626]
    ...
    set lstStations [ttk::treeview .stations.lstStations]
    ...
    # bind
    $cnv bind $back <ButtonPress-1> [namespace code {close_dialog .stations}]
    # TODO
  ...
  proc delete_station_from_favorites {} {
    ...
    if {$ui(treeIndex) ne ""} {
      ...
      set frequency [dict get $aDict -variables]
